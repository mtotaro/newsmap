...
const ARGENTINA: SourceSeed[] = [
  ...
  },
  {
    ...
    needsUserAgent: true,
    notes: 'Kirchnerist/progressive newspaper. Migrated to Arc Publishing — single general feed only, no per-section splits. Section inferred from URL. Old /rss/secciones/* URLs return 404. Verified May 2026.',
    feedSections: [
      { key: 'all', url: 'https://www.pagina12.com.ar/arc/outboundfeeds/rss/?outputType=xml', labelEs: 'Portada', labelEn: 'Home' },
    ],
  },
  {
    // Regional newspaper from Mendoza, Argentina. Strong local political and sports coverage.
    name: 'Diario Uno',
    slug: 'diario-uno-ar',
    countryCode: 'AR',
    region: 'latam',
    language: 'es',
    logoUrl: 'https://www.diariouno.com.ar/favicon.ico',
    websiteUrl: 'https://www.diariouno.com.ar',
    needsUserAgent: false,
    notes: 'Mendoza regional newspaper. RSS 2.0 per-section feeds at /rss/{section}.xml. Description only — no content:encoded, enricher will attempt full content. Verified May 2026.',
    feedSections: [
      { key: 'politics',      url: 'https://www.diariouno.com.ar/rss/politica.xml',      labelEs: 'Política',      labelEn: 'Politics' },
      { key: 'economy',       url: 'https://www.diariouno.com.ar/rss/economia.xml',      labelEs: 'Economía',      labelEn: 'Economy' },
      { key: 'world',         url: 'https://www.diariouno.com.ar/rss/sociedad.xml',      labelEs: 'Sociedad',      labelEn: 'Society' },
      { key: 'entertainment', url: 'https://www.diariouno.com.ar/rss/espectaculos.xml',  labelEs: 'Espectáculos',  labelEn: 'Entertainment' },
      { key: 'sports',        url: 'https://www.diariouno.com.ar/rss/polideportivo.xml', labelEs: 'Polideportivo', labelEn: 'Sports' },
    ],
  },
  {
